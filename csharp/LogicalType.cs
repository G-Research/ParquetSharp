...
namespace ParquetSharp
{
    ...
    public abstract class LogicalType : IDisposable, IEquatable<LogicalType>
    {
        ...
        public static LogicalType Timestamp(bool isAdjustedToUtc, TimeUnit timeUnit, bool forceSetConvertedType = false) => Create(ExceptionInfo.Return<bool, TimeUnit, bool, IntPtr>(isAdjustedToUtc, timeUnit, forceSetConvertedType, LogicalType_Timestamp));
