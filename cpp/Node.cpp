...
extern "C"
{
	...
	PARQUETSHARP_EXPORT ExceptionInfo* Node_Converted_Type(const std::shared_ptr<const schema::Node>* node, ConvertedType::type* converted_type)
	{
		TRYCATCH(*converted_type = (*node)->converted_type();)
	}
